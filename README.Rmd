...
Here are some basic examples showing how to obtain hydrologic unit boundaries by ID, point, envelope, and polygon. 

The default `layerid=5` corresponds to a "10-digit" HUC or "Watershed" level boundary.
